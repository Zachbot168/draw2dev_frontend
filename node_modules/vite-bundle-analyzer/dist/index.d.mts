...
export declare type DefaultSizes = 'stat' | 'gzip' | 'brotli';
...
declare type PathFormatter = (path: string, defaultWD: string) => string;

declare type PluginContext = ThisParameterType<RenderChunkFunction>;

export declare type QueryKind = 'gzip' | 'stat' | 'brotli';
